...
//    __block EtherscanProvider *e = [[EtherscanProvider alloc]initWithChainId:ChainIdHomestead apiKey:@"RCWEX6WYBXMJZHD5FD617NZ99TZADKBEDJ"];
    ...
    __block JsonRpcProvider *e = [[JsonRpcProvider alloc] initWithChainId:ChainIdHomestead url:[NSURL URLWithString:rpcIP]];
...
+(void)yy_estimateGasWithFromAddress:(NSString *)fromAddress
    ...
    __block Account *a;
    __block JsonRpcProvider *e = [[JsonRpcProvider alloc] initWithChainId:ChainIdMorden url:[NSURL URLWithString:rpcIP]];
